...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mSensorPED = mSensorManager.getDefaultSensor(Sensor.TYPE_STEP_DETECTOR);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                if (group.getCheckedButtonId() == R.id.toggleStart) {
                    ...
                    if(mSensorPED != null){
                        mSensorManager.registerListener(listener, mSensorPED, SensorManager.SENSOR_DELAY_NORMAL);
                    } else {
                        Toast.makeText(getContext(), "step detector not available", Toast.LENGTH_SHORT).show();
                    }
...
class StepCounterListener implements SensorEventListener {
    ...
    private void countSteps(float step) {
        ...
        Log.d("ANDROID STEPS: ", String.valueOf(mAndroidStepCount));
